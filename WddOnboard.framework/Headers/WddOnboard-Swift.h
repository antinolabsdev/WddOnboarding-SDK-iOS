...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WddOnboard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10WddOnboard11ColorSlider")
...
@interface ColorSlider (SWIFT_EXTENSION(WddOnboard))
...
SWIFT_CLASS("_TtC10WddOnboard18DefaultPreviewView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10WddOnboard6Floaty")
...
@interface Floaty (SWIFT_EXTENSION(WddOnboard))
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC10WddOnboard13FloatyManager")
...
SWIFT_CLASS("_TtC10WddOnboard20FloatyViewController")
...
SWIFT_CLASS("_TtC10WddOnboard12GradientView")
...
@interface GradientView (SWIFT_EXTENSION(WddOnboard))
...
///   </li>
/// </ol>
SWIFT_CLASS("_TtC10WddOnboard22ImageScannerController")
...
SWIFT_CLASS("_TtC10WddOnboard10WddOnboard")
@interface WddOnboard : NSObject
...
- (void)showWddButtonOn:(UIViewController * _Nonnull)viewController image:(UIImage * _Nullable)image;
- (void)hideWddButton;
